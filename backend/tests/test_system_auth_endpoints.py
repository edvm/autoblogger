    ...
    def test_register_duplicate_email(self):
        ...
        with patch('api.routers.system_auth.get_db') as mock_get_db:
            ...
            mock_db.query.return_value.filter.return_value.first.side_effect = [
                ...
                SystemUserFactory.create_mock_system_user(email=registration_data["email"])  # Email taken
            ]
...
class TestSystemUserLogin:
    ...
    def test_login_success(self):
        ...
        with patch('api.routers.system_auth.get_db') as mock_get_db:
            ...
            mock_db.query.return_value.filter.return_value.first.return_value = mock_system_user
            ...
            with patch('api.routers.system_auth.ApiKey', return_value=mock_api_key):
                with patch('api.routers.system_auth.ApiKey.generate_key', return_value=("abk_live_test_key", "hash")):
...
class TestApiKeyManagement:
    ...
    def test_create_api_key(self, authenticated_api_key_client):
        ...
        with patch('api.routers.system_auth.get_db') as mock_get_db:
            ...
            with patch('api.routers.system_auth.ApiKey', return_value=mock_api_key):
                with patch('api.routers.system_auth.ApiKey.generate_key', return_value=("abk_live_new_key", "hash")):
                    response = authenticated_api_key_client.post("/api/v1/auth/keys", json=key_data)
    ...
    def test_update_api_key(self, authenticated_api_key_client):
        ...
        with patch('api.routers.system_auth.get_db') as mock_get_db:
            ...
            response = authenticated_api_key_client.put(f"/api/v1/auth/keys/{key_id}", json=update_data)
    ...
    def test_revoke_api_key(self, authenticated_api_key_client):
        ...
        with patch('api.routers.system_auth.get_db') as mock_get_db:
            ...
            response = authenticated_api_key_client.delete(f"/api/v1/auth/keys/{key_id}")
